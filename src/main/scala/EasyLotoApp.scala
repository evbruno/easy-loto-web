...
import loto.{ApiRepo, BetProtocols, Result}
...
trait Service extends Protocols with MiscDirectives with RespondWithDirectives with BetProtocols {
...
object AkkaHttpMicroservice extends App with Service with ApiRepo {
